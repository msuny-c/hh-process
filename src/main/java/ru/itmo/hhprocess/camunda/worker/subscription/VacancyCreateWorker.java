...
public class VacancyCreateWorker extends VacancyFlowWorker {
    public VacancyCreateWorker(CamundaFormValidator formValidator,
    ...
    protected Map<String, Object> handle(String activityId, CamundaTaskVariables variables) {
        return handleCreate(activityId, variables);
    }
}
