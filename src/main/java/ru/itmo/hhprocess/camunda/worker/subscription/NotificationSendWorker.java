...
@CamundaWorkerSubscriptions.NotificationSend
public class NotificationSendWorker extends ApplicationFlowWorker {
    public NotificationSendWorker(CamundaFormValidator formValidator,
